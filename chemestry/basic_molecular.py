elements_dictionary = {
    ...
    "Rg": 272.0, "Cn": 277.0,
    #For some reason my National school system still have no mass for the following
...
#Anything made above this line is Ai because I cannot be bothered to make the lists
